...
abstract class BasicOperators extends SpecialOperators {
    ...
    public static Vector2 add_(Vector2 a, float b) {
        return add(new Vector2(), a, b, b);
    }

    public static Vector2 add_(Vector2 a, Vector2 b) {
        return add(new Vector2(), a, b.x, b.y);
    }
    ...
    public static Vector2 add(Vector2 res, Vector2 a, float b) {
        return add(res, a, b, b);
    }

    public static Vector2 add(Vector2 res, Vector2 a, Vector2 b) {
        return add(res, a, b.x, b.y);
    }

    public static Vector2 add(Vector2 res, Vector2 a, float bX, float bY) {
        res.x = a.x + bX;
        res.y = a.y + bY;
        return res;
    }
    ...
    public static Vector3 add_(Vector3 a, float b) {
        return add(new Vector3(), a, b, b, b);
    }

    public static Vector3 add_(Vector3 a, Vector3 b) {
        return add(new Vector3(), a, b.x, b.y, b.z);
    }
    ...
    public static Vector3 add(Vector3 res, Vector3 a, float b) {
        return add(res, a, b, b, b);
    }

    public static Vector3 add(Vector3 res, Vector3 a, Vector3 b) {
        return add(res, a, b.x, b.y, b.z);
    }

    public static Vector3 add(Vector3 res, Vector3 a, float bX, float bY, float bZ) {
        res.x = a.x + bX;
        res.y = a.y + bY;
        res.z = a.z + bZ;
        return res;
    ...
    public static Vector4 add_(Vector4 a, float b) {
        return add(new Vector4(), a, b, b, b, b);
    }

    public static Vector4 add_(Vector4 a, Vector4 b) {
        return add(new Vector4(), a, b.x, b.y, b.z, b.w);
    }
    ...
    public static Vector4 add(Vector4 res, Vector4 a, float b) {
        return add(res, a, b, b, b, b);
    }

    public static Vector4 add(Vector4 res, Vector4 a, Vector4 b) {
        return add(res, a, b.x, b.y, b.z, b.w);
    }

    public static Vector4 add(Vector4 res, Vector4 a, float bX, float bY, float bZ, float bW) {
        res.x = a.x + bX;
        res.y = a.y + bY;
        res.z = a.z + bZ;
        res.w = a.w + bW;
    ...
    public static Vector2 sub_(Vector2 a, float b) {
        return sub(new Vector2(), a, b, b);
    }

    public static Vector2 sub_(Vector2 a, Vector2 b) {
        return sub(new Vector2(), a, b.x, b.y);
    }
    ...
    public static Vector2 sub(Vector2 res, Vector2 a, float b) {
        return sub(res, a, b, b);
    }

    public static Vector2 sub(Vector2 res, Vector2 a, Vector2 b) {
        return sub(res, a, b.x, b.y);
    }

    public static Vector2 sub(Vector2 res, Vector2 a, float bX, float bY) {
        res.x = a.x - bX;
        res.y = a.y - bY;
        return res;
    }
    ...
    public static Vector3 sub_(Vector3 a, float b) {
        return sub(new Vector3(), a, b, b, b);
    }

    public static Vector3 sub_(Vector3 a, Vector3 b) {
        return sub(new Vector3(), a, b.x, b.y, b.z);
    }
    ...
    public static Vector3 sub(Vector3 res, Vector3 a, float b) {
        return sub(res, a, b, b, b);
    }

    public static Vector3 sub(Vector3 res, Vector3 a, Vector3 b) {
        return sub(res, a, b.x, b.y, b.z);
    }

    public static Vector3 sub(Vector3 res, Vector3 a, float bX, float bY, float bZ) {
        res.x = a.x - bX;
        res.y = a.y - bY;
        res.z = a.z - bZ;
        return res;
    ...
    public static Vector4 sub_(Vector4 a, float b) {
        return sub(new Vector4(), a, b, b, b, b);
    }

    public static Vector4 sub_(Vector4 a, Vector4 b) {
        return sub(new Vector4(), a, b.x, b.y, b.z, b.w);
    }
    ...
    public static Vector4 sub(Vector4 res, Vector4 a, float b) {
        return sub(res, a, b, b, b, b);
    }

    public static Vector4 sub(Vector4 res, Vector4 a, Vector4 b) {
        return sub(res, a, b.x, b.y, b.z, b.w);
    }

    public static Vector4 sub(Vector4 res, Vector4 a, float bX, float bY, float bZ, float bW) {
        res.x = a.x - bX;
        res.y = a.y - bY;
        res.z = a.z - bZ;
        res.w = a.w - bW;
    ...
    public static Vector2 mul_(Vector2 a, float b) {
        return mul(new Vector2(), a, b, b);
    }

    public static Vector2 mul_(Vector2 a, Vector2 b) {
        return mul(new Vector2(), a, b.x, b.y);
    }
    ...
    public static Vector2 mul(Vector2 res, Vector2 a, float b) {
        return mul(res, a, b, b);
    }

    public static Vector2 mul(Vector2 res, Vector2 a, Vector2 b) {
        return mul(res, a, b.x, b.y);
    }

    public static Vector2 mul(Vector2 res, Vector2 a, float bX, float bY) {
        res.x = a.x * bX;
        res.y = a.y * bY;
        return res;
    }
    ...
    public static Vector3 mul_(Vector3 a, float b) {
        return mul(new Vector3(), a, b, b, b);
    }

    public static Vector3 mul_(Vector3 a, Vector3 b) {
        return mul(new Vector3(), a, b.x, b.y, b.z);
    }
    ...
    public static Vector3 mul(Vector3 res, Vector3 a, float b) {
        return mul(res, a, b, b, b);
    }

    public static Vector3 mul(Vector3 res, Vector3 a, Vector3 b) {
        return mul(res, a, b.x, b.y, b.z);
    }

    public static Vector3 mul(Vector3 res, Vector3 a, float bX, float bY, float bZ) {
        res.x = a.x * bX;
        res.y = a.y * bY;
        res.z = a.z * bZ;
        return res;
    ...
    public static Vector4 mul_(Vector4 a, float b) {
        return mul(new Vector4(), a, b, b, b, b);
    }

    public static Vector4 mul_(Vector4 a, Vector4 b) {
        return mul(new Vector4(), a, b.x, b.y, b.z, b.w);
    }
    ...
    public static Vector4 mul(Vector4 res, Vector4 a, float b) {
        return mul(res, a, b, b, b, b);
    }

    public static Vector4 mul(Vector4 res, Vector4 a, Vector4 b) {
        return mul(res, a, b.x, b.y, b.z, b.w);
    }

    public static Vector4 mul(Vector4 res, Vector4 a, float bX, float bY, float bZ, float bW) {
        res.x = a.x * bX;
        res.y = a.y * bY;
        res.z = a.z * bZ;
        res.w = a.w * bW;
    ...
    public static Vector2 div_(Vector2 a, float b) {
        return div(new Vector2(), a, b, b);
    }

    public static Vector2 div_(Vector2 a, Vector2 b) {
        return div(new Vector2(), a, b.x, b.y);
    }
    ...
    public static Vector2 div(Vector2 res, Vector2 a, float b) {
        return div(res, a, b, b);
    }

    public static Vector2 div(Vector2 res, Vector2 a, Vector2 b) {
        return div(res, a, b.x, b.y);
    }

    public static Vector2 div(Vector2 res, Vector2 a, float bX, float bY) {
        res.x = a.x / bX;
        res.y = a.y / bY;
        return res;
    }
    ...
    public static Vector3 div_(Vector3 a, float b) {
        return div(new Vector3(), a, b, b, b);
    }

    public static Vector3 div_(Vector3 a, Vector3 b) {
        return div(new Vector3(), a, b.x, b.y, b.z);
    }
    ...
    public static Vector3 div(Vector3 res, Vector3 a, float b) {
        return div(res, a, b, b, b);
    }

    public static Vector3 div(Vector3 res, Vector3 a, Vector3 b) {
        return div(res, a, b.x, b.y, b.z);
    }

    public static Vector3 div(Vector3 res, Vector3 a, float bX, float bY, float bZ) {
        res.x = a.x / bX;
        res.y = a.y / bY;
        res.z = a.z / bZ;
        return res;
    ...
    public static Vector4 div_(Vector4 a, float b) {
        return div(new Vector4(), a, b, b, b, b);
    }

    public static Vector4 div_(Vector4 a, Vector4 b) {
        return div(new Vector4(), a, b.x, b.y, b.z, b.w);
    }
    ...
    public static Vector4 div(Vector4 res, Vector4 a, float b) {
        return div(res, a, b, b, b, b);
    }

    public static Vector4 div(Vector4 res, Vector4 a, Vector4 b) {
        return div(res, a, b.x, b.y, b.z, b.w);
    }

    public static Vector4 div(Vector4 res, Vector4 a, float bX, float bY, float bZ, float bW) {
        res.x = a.x / bX;
        res.y = a.y / bY;
        res.z = a.z / bZ;
        res.w = a.w / bW;
    ...
    public static Vector2 incr_(Vector2 v) {
        return incr(new Vector2(), v);
    }

    public static Vector2 incr(Vector2 v) {
        return incr(v, v);
    }

    public static Vector2 incr(Vector2 res, Vector2 a) {
        res.x = a.x + 1;
        res.y = a.y + 1;
        return res;
    }
    ...
    public static Vector3 incr_(Vector3 v) {
        return incr(new Vector3(), v);
    }

    public static Vector3 incr(Vector3 v) {
        return incr(v, v);
    }

    public static Vector3 incr(Vector3 res, Vector3 a) {
        res.x = a.x + 1;
        res.y = a.y + 1;
        res.z = a.z + 1;
        return res;
    ...
    public static Vector4 incr_(Vector4 v) {
        return incr(new Vector4(), v);
    }

    public static Vector4 incr(Vector4 v) {
        return incr(v, v);
    }

    public static Vector4 incr(Vector4 res, Vector4 a) {
        res.x = a.x + 1;
        res.y = a.y + 1;
        res.z = a.z + 1;
        res.w = a.w + 1;
    ...
    public static Vector2 decr_(Vector2 v) {
        return decr(new Vector2(), v);
    }

    public static Vector2 decr(Vector2 v) {
        return decr(v, v);
    }

    public static Vector2 decr(Vector2 res, Vector2 a) {
        res.x = a.x - 1;
        res.y = a.y - 1;
        return res;
    }
    ...
    public static Vector3 decr_(Vector3 v) {
        return decr(new Vector3(), v);
    }

    public static Vector3 decr(Vector3 v) {
        return decr(v, v);
    }

    public static Vector3 decr(Vector3 res, Vector3 a) {
        res.x = a.x - 1;
        res.y = a.y - 1;
        res.z = a.z - 1;
        return res;
    ...
    public static Vector4 decr_(Vector4 v) {
        return decr(new Vector4(), v);
    }

    public static Vector4 decr(Vector4 v) {
        return decr(v, v);
    }

    public static Vector4 decr(Vector4 res, Vector4 a) {
        res.x = a.x - 1;
        res.y = a.y - 1;
        res.z = a.z - 1;
        res.w = a.w - 1;
