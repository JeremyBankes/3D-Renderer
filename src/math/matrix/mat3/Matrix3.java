 ...
 * @author GBarbieri
 */
public class Matrix3 extends matrixQuery {
    ...
    // TODO transpose
    public Matrix3(float[] f, int offset) {
        this(
    ...
    public static Matrix3 cast(Quat q) {
    ...
    public Matrix3 set(float[] f, int offset) {
        set(
                f[offset + 0], f[offset + 1], f[offset + 2],
                f[offset + 3], f[offset + 4], f[offset + 5],
                f[offset + 6], f[offset + 7], f[offset + 8]);
    ...
    public Vector3 mul_(Vector3 v) {
        return mul(v, v);
    }
    
    
    public Vector3 mul(Vector3 right, Vector3 res) {
    ...
    public Matrix3 mul_(Matrix3 right) {
        return mul(right, new Matrix3());
    }
    ...
    public boolean equals(Matrix3 other, int maxUlps) {
...
//        }
    ...
    public Matrix4 toMat4_() {
        return toMat4(new Matrix4());
    }

    public Matrix4 toMat4(Matrix4 res) {
        return res.set(
                m00, m01, m02, 0, 
                m10, m11, m12, 0,
                m20, m21, m22, 0,
    ...
    public float[] toFa_() {
        return Matrix3.this.toFa(new float[9], 0);
    }

    public float[] toFa(float[] res) {
        return Matrix3.this.toFa(res, 0);
    }
