...
abstract class matrixTransform extends funcMatrix {
     ...
     * @return
     */
    public Matrix4 rotation(float radAngle, float x, float y, float z) {
    ...
    public Matrix4 rotate(float angle, Vector3 v) {
        return rotate(angle, v.x, v.y, v.z, (Matrix4) this);
    }

    public Matrix4 rotate(float angle, float x, float y, float z) {
        return rotate(angle, x, y, z, (Matrix4) this);
    }
     ...
     * @return
     */
    public Matrix4 rotate(float angle, float x, float y, float z, Matrix4 res) {
    ...
    public Matrix4 rotateX(double ang) {
        return rotateX((float) ang, (Matrix4) this);
    }

    public Matrix4 rotateX(float ang) {
        return rotateX(ang, (Matrix4) this);
    }

    public Matrix4 rotateX(float ang, Matrix4 res) {
    ...
    public Matrix4 rotateY(double ang) {
        return rotateY((float) ang, (Matrix4) this);
    }

    public Matrix4 rotateY(float ang) {
        return rotateY(ang, (Matrix4) this);
    }

    public Matrix4 rotateY(float ang, Matrix4 res) {
    	ang = (float) Math.toRadians(ang);
        float cos, sin;
        if (ang == (float) Math.PI || ang == -(float) Math.PI) {
            cos = -1.0f;
    ...
    public Matrix4 rotateZ(double ang) {
        return rotateZ((float) ang, (Matrix4) this);
    }

    public Matrix4 rotateZ(float ang) {
        return rotateZ(ang, (Matrix4) this);
    }

    public Matrix4 rotateZ(float ang, Matrix4 res) {
    	ang = (float) Math.toRadians(ang);
        float sin, cos;
        if (ang == (float) Math.PI || ang == -(float) Math.PI) {
            cos = -1.0f;
    ...
    public Matrix4 scale(Vector3 v, Matrix4 res) {
        return scale(v.x, v.y, v.z, res);
    }

    public Matrix4 scale(float x, float y, float z) {
        return scale(x, y, z, (Matrix4) this);
    }

    public Matrix4 scale(float x, float y, float z, Matrix4 res) {
        res.m00 = m00 * x;
        res.m01 = m01 * x;
        res.m02 = m02 * x;
        res.m03 = m03 * x;
    ...
    public Matrix4 translation(Vector3 v) {
        return translation((Matrix4) this, v.x, v.y, v.z);
    }

    public Matrix4 translation(float x, float y, float z) {
        return translation((Matrix4) this, x, y, z);
    }

    public static Matrix4 translation(Matrix4 result, float x, float y, float z) {
        result.m00 = 1.0f;
        result.m01 = 0.0f;
        result.m02 = 0.0f;
        result.m03 = 0.0f;
    ...
    public Matrix4 translate(Vector3 v) {
        return translate((Matrix4) this, v.x, v.y, v.z);
    }

    public Matrix4 translate(float[] t) {
        return translate((Matrix4) this, t[0], t[1], t[2]);
    }

    public Matrix4 translate(float x, float y, float z) {
        return translate((Matrix4) this, x, y, z);
    }

    public Matrix4 translate(Matrix4 res, Vector3 v) {
        return translate(res, v.x, v.y, v.z);
    }

    public Matrix4 translate(Matrix4 res, float x, float y, float z) {
    ...
    public Matrix4 lookAt(Vector3 eye, Vector3 center, Vector3 up) {
        return Glm.lookAt(eye, center, up, (Matrix4) this);
    }
    ...
    public Matrix4 ortho(float left, float right, float bottom, float top, float zNear, float zFar) {
        return Glm.ortho((Matrix4) this, left, right, bottom, top, zNear, zFar);
    }

    public Matrix4 perspective(float fovy, float aspect, float zNear, float zFar) {
        return Glm.perspective(fovy, aspect, zNear, zFar, (Matrix4) this);
    }

    public Matrix4 perspectiveFov(float fov, float width, float height, float zNear, float zFar) {
        return Glm.perspectiveFov(fov, width, height, zNear, zFar, (Matrix4) this);
    }
}
