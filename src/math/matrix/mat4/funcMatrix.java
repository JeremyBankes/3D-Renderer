...
abstract class funcMatrix {
    ...
    public Matrix4 inverse() {
        return inverse((Matrix4) this);
    }
    
    public Matrix4 inverse_() {
        return inverse(new Matrix4());
    }

    public Matrix4 inverse(Matrix4 dest) {
    ...
    public Matrix4 invTransp() {
        return invTransp3((Matrix4) this);
    }

    public Matrix4 invTransp3_() {
        return invTransp3(new Matrix4());
    }

    public Matrix4 invTransp3(Matrix4 dest) {
        float det = det3();
        float s = 1.0f / det;
    ...
    public Matrix4 transpose() {
        return transpose((Matrix4) this);
    }

    public Matrix4 transpose(Matrix4 dest) {
        return transpose((Matrix4) this, dest);
    }
