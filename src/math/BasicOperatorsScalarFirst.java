...
abstract class BasicOperatorsScalarFirst extends BasicOperators {
    ...
    public static Vector2 add_(float a, Vector2 b) {
        return BasicOperators.add(new Vector2(), b, a, a);
    }
    ...
    public static Vector2 add(Vector2 res, float a, Vector2 b) {
        return BasicOperators.add(res, b, a, a);
    }

    public static Vector2 add(Vector2 res, float aX, float aY, Vector2 b) {
    ...
    public static Vector3 add_(float a, Vector3 b) {
        return BasicOperators.add(new Vector3(), b, a, a, a);
    }
    ...
    public static Vector3 add(Vector3 res, float a, Vector3 b) {
        return BasicOperators.add(res, b, a, a, a);
    }

    public static Vector3 add(Vector3 res, float aX, float aY, float aZ, Vector3 b) {
    ...
    public static Vector4 add_(float a, Vector4 b) {
        return BasicOperators.add(new Vector4(), b, a, a, a, a);
    }
    ...
    public static Vector4 add(Vector4 res, float a, Vector4 b) {
        return BasicOperators.add(res, b, a, a, a, a);
    }

    public static Vector4 add(Vector4 res, float aX, float aY, float aZ, float aW, Vector4 b) {
    ...
    public static Vector2 sub_(float a, Vector2 b) {
        return sub(new Vector2(), a, a, b);
    }
    ...
    public static Vector2 sub(Vector2 res, float a, Vector2 b) {
        return sub(res, a, a, b);
    }

    public static Vector2 sub(Vector2 res, float aX, float aY, Vector2 b) {
        res.x = aX - b.x;
        res.y = aY - b.y;
        return res;
    }
    ...
    public static Vector3 sub_(float a, Vector3 b) {
        return sub(new Vector3(), a, a, a, b);
    }
    ...
    public static Vector3 sub(Vector3 res, float a, Vector3 b) {
        return sub(res, a, a, a, b);
    }

    public static Vector3 sub(Vector3 res, float aX, float aY, float aZ, Vector3 b) {
        res.x = aX - b.x;
        res.y = aY - b.y;
        res.z = aZ - b.z;
        return res;
    ...
    public static Vector4 sub_(float a, Vector4 b) {
        return sub(new Vector4(), a, a, a, a, b);
    }
    ...
    public static Vector4 sub(Vector4 res, float a, Vector4 b) {
        return sub(res, a, a, a, a, b);
    }

    public static Vector4 sub(Vector4 res, float aX, float aY, float aZ, float aW, Vector4 b) {
        res.x = aX - b.x;
        res.y = aY - b.y;
        res.z = aZ - b.z;
        res.w = aW - b.w;
    ...
    public static Vector2 mul_(float a, Vector2 b) {
        return BasicOperators.mul(new Vector2(), b, a, a);
    }
    ...
    public static Vector2 mul(Vector2 res, float a, Vector2 b) {
        return BasicOperators.mul(res, b, a, a);
    }

    public static Vector2 mul(Vector2 res, float aX, float aY, Vector2 b) {
    ...
    public static Vector3 mul_(float a, Vector3 b) {
        return BasicOperators.mul(new Vector3(), b, a, a, a);
    }
    ...
    public static Vector3 mul(Vector3 res, float a, Vector3 b) {
        return BasicOperators.mul(res, b, a, a, a);
    }

    public static Vector3 mul(Vector3 res, float aX, float aY, float aZ, Vector3 b) {
    ...
    public static Vector4 mul_(float a, Vector4 b) {
        return BasicOperators.mul(new Vector4(), b, a, a, a, a);
    }
    ...
    public static Vector4 mul(Vector4 res, float a, Vector4 b) {
        return BasicOperators.mul(res, b, a, a, a, a);
    }

    public static Vector4 mul(Vector4 res, float aX, float aY, float aZ, float aW, Vector4 b) {
    ...
    public static Vector2 div_(float a, Vector2 b) {
        return div(new Vector2(), a, a, b);
    }
    ...
    public static Vector2 div(Vector2 res, float a, Vector2 b) {
        return div(res, a, a, b);
    }

    public static Vector2 div(Vector2 res, float aX, float aY, Vector2 b) {
        res.x = aX / b.x;
        res.y = aY / b.y;
        return res;
    }
    ...
    public static Vector3 div_(float a, Vector3 b) {
        return BasicOperators.div(new Vector3(), b, a, a, a);
    }
    ...
    public static Vector3 div(Vector3 res, float a, Vector3 b) {
        return BasicOperators.div(res, b, a, a, a);
    }

    public static Vector3 div(Vector3 res, float aX, float aY, float aZ, Vector3 b) {
    ...
    public static Vector4 div_(float a, Vector4 b) {
        return BasicOperators.div(new Vector4(), b, a, a, a, a);
    }
    ...
    public static Vector4 div(Vector4 res, float a, Vector4 b) {
        return BasicOperators.div(res, b, a, a, a, a);
    }

    public static Vector4 div(Vector4 res, float aX, float aY, float aZ, float aW, Vector4 b) {
