...
abstract class FuncRelational extends BasicOperatorsScalarFirst {
    ...
    // any ----------------------------------------------------------------------------------------------------------
    public static boolean any(Vector2 v) {
        return v.x != 0 | v.y != 0;
    }
    ...
    public static boolean any(Vector3 v) {
    ...
    public static boolean any(Vector4 v) {
        return v.x != 0 | v.y != 0 | v.z != 0;
    }
    ...
    // all ----------------------------------------------------------------------------------------------------------
    public static boolean all(Vector2 v) {
        return v.x != 0 & v.y != 0;
    }
    ...
    public static boolean all(Vector3 v) {
        return v.x != 0 & v.y != 0 & v.z != 0;
    }
    ...
    public static boolean all(Vector4 v) {
        return v.x != 0 & v.y != 0 & v.z != 0;
    }
    ...
    // not ----------------------------------------------------------------------------------------------------------
    public static Vector2 not_(Vector2 v) {
        return not(v, new Vector2());
    }

    public static Vector2 not(Vector2 v, Vector2 res) {
        res.x = v.x == 0 ? 1 : 0;
        res.y = v.y == 0 ? 1 : 0;
        return res;
    }
    ...
    public static Vector3 not_(Vector3 v) {
        return not(v, new Vector3());
    }

    public static Vector3 not(Vector3 v, Vector3 res) {
        res.x = v.x == 0 ? 1 : 0;
        res.y = v.y == 0 ? 1 : 0;
        res.z = v.z == 0 ? 1 : 0;
        return res;
    ...
    public static Vector4 not_(Vector4 v) {
        return not(v, new Vector4());
    }

    public static Vector4 not(Vector4 v, Vector4 res) {
        res.x = v.x == 0 ? 1 : 0;
        res.y = v.y == 0 ? 1 : 0;
        res.z = v.z == 0 ? 1 : 0;
        res.w = v.w == 0 ? 1 : 0;
    ...
    public static Vec2bool lessThan__(Vector2 a, Vector2 b) {
        return lessThan(a, b, new Vec2bool());
    }

    public static Vec2bool lessThan(Vector2 a, Vector2 b, Vec2bool res) {
        res.x = a.x < b.x;
        res.y = a.y < b.y;
        return res;
    }
    ...
    public static Vector2 lessThan_(Vector2 a, Vector2 b) {
        return lessThan(a, b, new Vector2());
    }

    public static Vector2 lessThan(Vector2 a, Vector2 b, Vector2 res) {
        res.x = a.x < b.x ? 1 : 0;
        res.y = a.y < b.y ? 1 : 0;
        return res;
    }
    ...
    public static Vec3bool lessThan__(Vector3 a, Vector3 b) {
        return lessThan(a, b, new Vec3bool());
    }

    public static Vec3bool lessThan(Vector3 a, Vector3 b, Vec3bool res) {
        res.x = a.x < b.x;
        res.y = a.y < b.y;
        res.z = a.z < b.z;
        return res;
    ...
    public static Vector3 lessThan_(Vector3 a, Vector3 b) {
        return lessThan(a, b, new Vector3());
    }

    public static Vector3 lessThan(Vector3 a, Vector3 b, Vector3 res) {
        res.x = a.x < b.x ? 1 : 0;
        res.y = a.y < b.y ? 1 : 0;
        res.z = a.z < b.z ? 1 : 0;
        return res;
    ...
    public static Vec4bool lessThan__(Vector4 a, Vector4 b) {
        return lessThan(a, b, new Vec4bool());
    }

    public static Vec4bool lessThan(Vector4 a, Vector4 b, Vec4bool res) {
        res.x = a.x < b.x;
        res.y = a.y < b.y;
        res.z = a.z < b.z;
        res.w = a.w < b.w;
    ...
    public static Vector4 lessThan_(Vector4 a, Vector4 b) {
        return lessThan(a, b, new Vector4());
    }

    public static Vector4 lessThan(Vector4 a, Vector4 b, Vector4 res) {
        res.x = a.x < b.x ? 1 : 0;
        res.y = a.y < b.y ? 1 : 0;
        res.z = a.z < b.z ? 1 : 0;
        res.w = a.w < b.w ? 1 : 0;
    ...
    public static Vec2bool lessThanEqual__(Vector2 a, Vector2 b) {
        return lessThanEqual(a, b, new Vec2bool());
    }

    public static Vec2bool lessThanEqual(Vector2 a, Vector2 b, Vec2bool res) {
        res.x = a.x <= b.x;
        res.y = a.y <= b.y;
        return res;
    }
    ...
    public static Vector2 lessThanEqual_(Vector2 a, Vector2 b) {
        return lessThanEqual(a, b, new Vector2());
    }

    public static Vector2 lessThanEqual(Vector2 a, Vector2 b, Vector2 res) {
        res.x = a.x <= b.x ? 1 : 0;
        res.y = a.y <= b.y ? 1 : 0;
        return res;
    }
    ...
    public static Vec3bool lessThanEqual__(Vector3 a, Vector3 b) {
        return lessThanEqual(a, b, new Vec3bool());
    }

    public static Vec3bool lessThanEqual(Vector3 a, Vector3 b, Vec3bool res) {
        res.x = a.x <= b.x;
        res.y = a.y <= b.y;
        res.z = a.z <= b.z;
        return res;
    ...
    public static Vector3 lessThanEqual_(Vector3 a, Vector3 b) {
        return lessThanEqual(a, b, new Vector3());
    }

    public static Vector3 lessThanEqual(Vector3 a, Vector3 b, Vector3 res) {
        res.x = a.x <= b.x ? 1 : 0;
        res.y = a.y <= b.y ? 1 : 0;
        res.z = a.z <= b.z ? 1 : 0;
        return res;
    ...
    public static Vec4bool lessThanEqual__(Vector4 a, Vector4 b) {
        return lessThanEqual(a, b, new Vec4bool());
    }

    public static Vec4bool lessThanEqual(Vector4 a, Vector4 b, Vec4bool res) {
        res.x = a.x <= b.x;
        res.y = a.y <= b.y;
        res.z = a.z <= b.z;
        res.w = a.w <= b.w;
    ...
    public static Vector4 lessThanEqual_(Vector4 a, Vector4 b) {
        return lessThanEqual(a, b, new Vector4());
    }

    public static Vector4 lessThanEqual(Vector4 a, Vector4 b, Vector4 res) {
        res.x = a.x <= b.x ? 1 : 0;
        res.y = a.y <= b.y ? 1 : 0;
        res.z = a.z <= b.z ? 1 : 0;
        res.w = a.w <= b.w ? 1 : 0;
    ...
    public static Vec2bool greaterThan__(Vector2 a, Vector2 b) {
        return greaterThan(a, b, new Vec2bool());
    }

    public static Vec2bool greaterThan(Vector2 a, Vector2 b, Vec2bool res) {
        res.x = a.x > b.x;
        res.y = a.y > b.y;
        return res;
    }
    ...
    public static Vector2 greaterThan_(Vector2 a, Vector2 b) {
        return greaterThan(a, b, new Vector2());
    }

    public static Vector2 greaterThan(Vector2 a, Vector2 b, Vector2 res) {
        res.x = a.x > b.x ? 1 : 0;
        res.y = a.y > b.y ? 1 : 0;
        return res;
    }
    ...
    public static Vec3bool greaterThan__(Vector3 a, Vector3 b) {
        return greaterThan(a, b, new Vec3bool());
    }

    public static Vec3bool greaterThan(Vector3 a, Vector3 b, Vec3bool res) {
        res.x = a.x > b.x;
        res.y = a.y > b.y;
        res.z = a.z > b.z;
        return res;
    ...
    public static Vector3 greaterThan_(Vector3 a, Vector3 b) {
        return greaterThan(a, b, new Vector3());
    }

    public static Vector3 greaterThan(Vector3 a, Vector3 b, Vector3 res) {
        res.x = a.x > b.x ? 1 : 0;
        res.y = a.y > b.y ? 1 : 0;
        res.z = a.z > b.z ? 1 : 0;
        return res;
    ...
    public static Vec4bool greaterThan__(Vector4 a, Vector4 b) {
        return greaterThan(a, b, new Vec4bool());
    }

    public static Vec4bool greaterThan(Vector4 a, Vector4 b, Vec4bool res) {
        res.x = a.x > b.x;
        res.y = a.y > b.y;
        res.z = a.z > b.z;
        res.w = a.w > b.w;
    ...
    public static Vector4 greaterThan_(Vector4 a, Vector4 b) {
        return greaterThan(a, b, new Vector4());
    }

    public static Vector4 greaterThan(Vector4 a, Vector4 b, Vector4 res) {
        res.x = a.x > b.x ? 1 : 0;
        res.y = a.y > b.y ? 1 : 0;
        res.z = a.z > b.z ? 1 : 0;
        res.w = a.w > b.w ? 1 : 0;
    ...
    public static Vec2bool greaterThanEqual__(Vector2 a, Vector2 b) {
        return greaterThanEqual(a, b, new Vec2bool());
    }

    public static Vec2bool greaterThanEqual(Vector2 a, Vector2 b, Vec2bool res) {
        res.x = a.x >= b.x;
        res.y = a.y >= b.y;
        return res;
    }
    ...
    public static Vector2 greaterThanEqual_(Vector2 a, Vector2 b) {
        return greaterThanEqual(a, b, new Vector2());
    }

    public static Vector2 greaterThanEqual(Vector2 a, Vector2 b, Vector2 res) {
        res.x = a.x >= b.x ? 1 : 0;
        res.y = a.y >= b.y ? 1 : 0;
        return res;
    }
    ...
    public static Vec3bool greaterThanEqual__(Vector3 a, Vector3 b) {
        return greaterThanEqual(a, b, new Vec3bool());
    }

    public static Vec3bool greaterThanEqual(Vector3 a, Vector3 b, Vec3bool res) {
        res.x = a.x >= b.x;
        res.y = a.y >= b.y;
        res.z = a.z >= b.z;
        return res;
    ...
    public static Vector3 greaterThanEqual_(Vector3 a, Vector3 b) {
        return greaterThanEqual(a, b, new Vector3());
    }

    public static Vector3 greaterThanEqual(Vector3 a, Vector3 b, Vector3 res) {
        res.x = a.x >= b.x ? 1 : 0;
        res.y = a.y >= b.y ? 1 : 0;
        res.z = a.z >= b.z ? 1 : 0;
        return res;
    ...
    public static Vec4bool greaterThanEqual__(Vector4 a, Vector4 b) {
        return greaterThanEqual(a, b, new Vec4bool());
    }

    public static Vec4bool greaterThanEqual(Vector4 a, Vector4 b, Vec4bool res) {
        res.x = a.x >= b.x;
        res.y = a.y >= b.y;
        res.z = a.z >= b.z;
        res.w = a.w >= b.w;
    ...
    public static Vector4 greaterThanEqual_(Vector4 a, Vector4 b) {
        return greaterThanEqual(a, b, new Vector4());
    }

    public static Vector4 greaterThanEqual(Vector4 a, Vector4 b, Vector4 res) {
        res.x = a.x >= b.x ? 1 : 0;
        res.y = a.y >= b.y ? 1 : 0;
        res.z = a.z >= b.z ? 1 : 0;
        res.w = a.w >= b.w ? 1 : 0;
    ...
    public static Vec2bool equal__(Vector2 a, Vector2 b) {
        return equal(a, b, new Vec2bool());
    }

    public static Vec2bool equal(Vector2 a, Vector2 b, Vec2bool res) {
        res.x = a.x == b.x;
        res.y = a.y == b.y;
        return res;
    }
    ...
    public static Vector2 equal_(Vector2 a, Vector2 b) {
        return equal(a, b, new Vector2());
    }

    public static Vector2 equal(Vector2 a, Vector2 b, Vector2 res) {
        res.x = a.x == b.x ? 1 : 0;
        res.y = a.y == b.y ? 1 : 0;
        return res;
    }
    ...
    public static Vec3bool equal__(Vector3 a, Vector3 b) {
        return equal(a, b, new Vec3bool());
    }

    public static Vec3bool equal(Vector3 a, Vector3 b, Vec3bool res) {
        res.x = a.x == b.x;
        res.y = a.y == b.y;
        res.z = a.z == b.z;
        return res;
    ...
    public static Vector3 equal_(Vector3 a, Vector3 b) {
        return equal(a, b, new Vector3());
    }

    public static Vector3 equal(Vector3 a, Vector3 b, Vector3 res) {
        res.x = a.x == b.x ? 1 : 0;
        res.y = a.y == b.y ? 1 : 0;
        res.z = a.z == b.z ? 1 : 0;
        return res;
    ...
    public static Vec4bool equal__(Vector4 a, Vector4 b) {
        return equal(a, b, new Vec4bool());
    }

    public static Vec4bool equal(Vector4 a, Vector4 b, Vec4bool res) {
        res.x = a.x == b.x;
        res.y = a.y == b.y;
        res.z = a.z == b.z;
        res.w = a.w == b.w;
    ...
    public static Vector4 equal_(Vector4 a, Vector4 b) {
        return equal(a, b, new Vector4());
    }

    public static Vector4 equal(Vector4 a, Vector4 b, Vector4 res) {
        res.x = a.x == b.x ? 1 : 0;
        res.y = a.y == b.y ? 1 : 0;
        res.z = a.z == b.z ? 1 : 0;
        res.w = a.w == b.w ? 1 : 0;
    ...
    public static Vec2bool notEqual__(Vector2 a, Vector2 b) {
        return notEqual(a, b, new Vec2bool());
    }

    public static Vec2bool notEqual(Vector2 a, Vector2 b, Vec2bool res) {
        res.x = a.x != b.x;
        res.y = a.y != b.y;
        return res;
    }
    ...
    public static Vector2 notEqual_(Vector2 a, Vector2 b) {
        return notEqual(a, b, new Vector2());
    }

    public static Vector2 notEqual(Vector2 a, Vector2 b, Vector2 res) {
        res.x = a.x != b.x ? 1 : 0;
        res.y = a.y != b.y ? 1 : 0;
        return res;
    }
    ...
    public static Vec3bool notEqual__(Vector3 a, Vector3 b) {
        return notEqual(a, b, new Vec3bool());
    }

    public static Vec3bool notEqual(Vector3 a, Vector3 b, Vec3bool res) {
        res.x = a.x != b.x;
        res.y = a.y != b.y;
        res.z = a.z != b.z;
        return res;
    ...
    public static Vector3 notEqual_(Vector3 a, Vector3 b) {
        return notEqual(a, b, new Vector3());
    }

    public static Vector3 notEqual(Vector3 a, Vector3 b, Vector3 res) {
        res.x = a.x != b.x ? 1 : 0;
        res.y = a.y != b.y ? 1 : 0;
        res.z = a.z != b.z ? 1 : 0;
        return res;
    ...
    public static Vec4bool notEqual__(Vector4 a, Vector4 b) {
        return notEqual(a, b, new Vec4bool());
    }

    public static Vec4bool notEqual(Vector4 a, Vector4 b, Vec4bool res) {
        res.x = a.x != b.x;
        res.y = a.y != b.y;
        res.z = a.z != b.z;
        res.w = a.w != b.w;
    ...
    public static Vector4 notEqual_(Vector4 a, Vector4 b) {
        return notEqual(a, b, new Vector4());
    }

    public static Vector4 notEqual(Vector4 a, Vector4 b, Vector4 res) {
        res.x = a.x != b.x ? 1 : 0;
        res.y = a.y != b.y ? 1 : 0;
        res.z = a.z != b.z ? 1 : 0;
        res.w = a.w != b.w ? 1 : 0;
