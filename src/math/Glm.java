...
public class Glm extends Noise {
    ...
    public static Vector3 linearRand(Vector3 min, Vector3 max, Vector3 res) {
        return Vector3.linearRand(min, max, res);
    }

    public static Vector3 linearRand_(Vector3 min, Vector3 max) {
        return Vector3.linearRand_(min, max);
    }

    public static Vector3 project_(Vector3 obj, Matrix4 model, Matrix4 proj, Vector4 viewport) {
        return project(obj, model, proj, viewport, new Vector3());
    }

    public static Vector3 project(Vector3 obj, Matrix4 model, Matrix4 proj, Vector4 viewport, Vector3 res) {
