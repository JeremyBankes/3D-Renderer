...
public class Quat extends funcGeometric {
    ...
    public Quat set(float f, Vector3 v) {
    ...
    public static Quat cast_(Matrix4 m) {
        return cast(m, new Quat());
    }
    
    public static Quat cast(Matrix4 m, Quat res) {
    ...
    public Matrix4 toMat_() {
        return toMat(new Matrix4());
    }

    public Matrix4 toMat(Matrix4 res) {
